...
namespace Naninovel
{
    ...
    public interface IAudioPlayer
    {
        ...
        /// <summary>
        /// Checks whether provided is currently playing.
        /// </summary>
        ...
        /// </summary>
        UniTask StopAsync (AudioClip clip, float fadeOutTime, CancellationToken cancellationToken = default);
        /// <summary>
        /// Stops playback of all the playing clips fading out volume over the provided time (in seconds).
        /// </summary>
        UniTask StopAllAsync (float fadeOutTime, CancellationToken cancellationToken = default);
        /// <summary>
